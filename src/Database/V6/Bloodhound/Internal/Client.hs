...
module Database.V6.Bloodhound.Internal.Client where
...
import           Database.V6.Bloodhound.Internal.StringlyTyped
...
data BHEnv = BHEnv { bhServer      :: Server
                   ...
                   -- ^ Low-level hook that is run before every request is sent.
                   -- ^ Used to implement custom authentication strategies.
                   -- ^ Defaults to 'return' with 'mkBHEnv'.
                   }
...
data NodeThreadPoolsStats = NodeThreadPoolsStats {
    ...
    , nodeThreadPoolsStatsBulk              :: Maybe NodeThreadPoolStats
...
data NodeThreadPoolsInfo = NodeThreadPoolsInfo {
    ...
    , nodeThreadPoolsBulk              :: Maybe NodeThreadPoolInfo
...
instance FromJSON ThreadPoolType where
  parseJSON = withText "ThreadPoolType" parse
    where
      ...
      parse "fixed_auto_queue_size" = return ThreadPoolSearch
