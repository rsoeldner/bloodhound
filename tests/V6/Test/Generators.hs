...
instance Arbitrary Query where
  arbitrary =
    ...
    $ oneof [ TermQuery <$> arbitrary <*> arbitrary
            ...
            -- , ParentIdQuery <$> arbitrary
            ]
  -- TODO: Implement shrink
  -- shrink = genericShrink

makeArbitrary ''DocumentParent
instance Arbitrary DocumentParent where arbitrary = arbitraryDocumentParent
...
instance Arbitrary TemplateSource where
  arbitrary = TemplateSource <$> arbitrary <*> pure []
...
makeArbitrary ''TemplateQuery
instance Arbitrary TemplateQuery where arbitrary = arbitraryTemplateQuery
